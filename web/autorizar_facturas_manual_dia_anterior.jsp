<%-- 
    ...
    Author     : jorjoluiso
--%>
<%@page import="com.jorge.utilidades.FechaUtils"%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <h2>Autorizar Facturas del día anterior</h2>
            <form name="autorizar_facturas" action="autorizar_facturas.jsp" class="navbar-form navbar-form" role="search">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="fecha" value="<%= new SimpleDateFormat("dd/MM/yyyy").format(FechaUtils.sumarRestarDiasFecha(new Date(), -1))%>" class="form-control" placeholder="dd/mm/aaaa" aria-describedby="basic-addon1">
                </div>
            ...
            <div class="jumbotron">
                <%
                    ...
                    if (request.getParameter("fecha") == null) {
                        date = new SimpleDateFormat("dd/MM/yyyy").format(FechaUtils.sumarRestarDiasFecha(new Date(), -1));
                    } else {
