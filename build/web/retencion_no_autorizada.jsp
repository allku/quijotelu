<%-- 
    Document   : retencion_no_autorizada
    Created on : 08/01/2015, 9:36:56
    Author     : jorjoluiso
--%>
...
<html>
    <head>
        ...
        <title>Retenciones no autorizadas</title>
    ...
    <body>
        ...
        <div class="container">
            <h2>Retenciones no autorizadas</h2>
            <form name="consulta_no_autorizada" action="retencion_no_autorizada.jsp" class="navbar-form navbar-form" role="search">
            ...
            <%
                try {
                    ...
                    preparedStatement = conn.prepareStatement(reporte.retencionesNoAutorizadas);
                ...
                <tbody>
                    <%
                            while (rs.next()) {
                                ...
                                out.println("<td><a href=\"estado_comprobante.jsp?codigo=" + rs.getString(1) + "&numero=" + rs.getString(2) + "\" target=\"_blank\">" + rs.getString(7) + "</a></td>");
