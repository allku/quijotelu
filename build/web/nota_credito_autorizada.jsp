<%-- 
    Document   : nota_credito_autorizada
    Created on : 14/01/2015, 10:29:32
    Author     : jorjoluiso
--%>
...
<html>
    <head>
        ...
        <title>Notas de crédito autorizada</title>
    ...
    <body>
        ...
        <div class="container">
            <h2>Notas de crédito autorizadas</h2>
            <form name="consulta_autorizada" action="nota_credito_autorizada.jsp" class="navbar-form navbar-form" role="search">
            ...
            <%
                try {
                    ...
                    preparedStatement = conn.prepareStatement(reporte.notasCreditoAutorizadas);
