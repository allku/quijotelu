...
public class Detalle {
    ...
    public Detalle(String CodigoPrincipal, String Descripcion, float Cantidad, float PrecioUnitario, float Descuento, float PrecioTotalSinImpuesto, Impuestos impuestos) {
