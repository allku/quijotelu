...
import com.jorge.utilidades.Respuesta;
...
public class EnvioComprobantesWS {
    ...
    public EnvioComprobantesWS(String wsdlLocation) throws MalformedURLException {
         ...
         */
        this.service = new RecepcionComprobantesService(new URL(wsdlLocation), new QName("http://ec.gob.sri.ws.recepcion", "RecepcionComprobantesService"));
    }
    ...
    public static RespuestaSolicitud obtenerRespuestaEnvio(File archivo, String claveDeAcceso, String urlWsdl) {
        ...
        respuesta = cliente.enviarComprobante(archivo, "1.0.0");
