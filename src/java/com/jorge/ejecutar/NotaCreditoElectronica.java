...
public class NotaCreditoElectronica {
    ...
    public NotaCreditoElectronica(String CodigoComprobante, String NumeroComprobante) {
    ...
    public String ejecutar() {
        ...
        GeneraNotaCredito ncXML = new GeneraNotaCredito();
        ...
        NombreArchivo = ncXML.genera(codigoComprobante, numeroComprobante, RutaArchivoGenerado);
